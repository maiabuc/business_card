          ...
          <div className="pc-content pc-avatar-content">
            ...
            {showUserInfo && (
              <>
                ...
                {/* Projects Section */}
                {showProjectsButton && (
                  <div className="pc-projects-info">
                    <div className="pc-user-details">
                      <div className="pc-mini-avatar">
                        <img
                      ...
                      <div className="pc-user-text">
                        <div className="pc-status">Portfolio</div>
                      </div>
                    </div>
                    <button
                      className="pc-contact-btn pc-projects-btn"
                      onClick={handleProjectsClick}
                      style={{ pointerEvents: "auto" }}
                      type="button"
                      aria-label={`View ${name || "user"}'s projects`}
                    >
                      {projectsText}
                    </button>
                  </div>
